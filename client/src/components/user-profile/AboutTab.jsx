    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex-col gap-4 border border-gray-300 rounded-xl p-4 mb-4">
                ...
                <p className="body-md mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, voluptate.
            ...
            <div className="flex-col gap-4 border border-gray-300 rounded-xl p-4 mb-4">
                <h3 className="heading-md">Colaboration Status</h3>
                <p className="body-md mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, voluptate.</p>
            </div>
            <div className="flex-col gap-4 border border-gray-300 rounded-xl p-4 mb-4">
                <h3 className="heading-md">Current Focus</h3>
                <p className="body-md mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, voluptate.</p>
            </div>
            <div className="flex-col gap-4 border border-gray-300 rounded-xl p-4 mb-4">
            ...
            <div className="flex-col gap-4 border border-gray-300 rounded-xl p-4 mb-4">
                <h3 className="heading-md">Social Links</h3>
                <p className="body-md mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, voluptate.</p>
            </div>
        </div>
    );
