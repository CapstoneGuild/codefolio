...
const PostCard = () => {
    ...
    return (
        <article className='w-full rounded-xl border border-gray-200 bg-white shadow-sm transition duration-300 hover:shadow-md'>
            ...
            <div className='flex items-center justify-between gap-3'>
                <div className='flex items-center gap-2.5'>
                    ...
                    <div className='leading-tight'>
                        <h1 className='text-sm font-semibold text-gray-800'>Jane Doe</h1>
                        <p className='text-[0.7rem] text-gray-500'>@janedoe</p>
                    </div>
                </div>
            ...
            <p className='mt-3 text-sm leading-6 text-gray-600'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Libero placeat necessitatibus, iure modi rem enim excepturi inventore laudantium, ipsum temporibus nemo officiis.</p>

            <div className='mt-3 flex flex-wrap gap-2'>
                {hashtags.map((tag, index) => (
                    <span key={index} className='text-[0.65rem] text-gray-600'>
                        #{tag}
                    </span>
                ))}
            </div>
            ...
            <div className='mt-4 flex items-center gap-3 text-sm text-gray-500'>
                <div onClick={() => setIsStarred(!isStarred)} className='flex items-center gap-1 rounded-full border border-gray-200 px-2.5 py-1'>
